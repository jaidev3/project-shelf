...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-800 text-white py-12 dark:bg-neutral-900 dark:text-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 dark:text-gray-400 mb-4">
              Showcase your creative work with beautiful portfolios and detailed
              case studies.
            </p>
